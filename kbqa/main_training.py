...
if __name__ == '__main__':
    ...
    # query_list.read_query_file('../../data/sample.data')
    query_list.read_query_file(gl.training_data_split_file_name)
    me = mention_extractor.MentionExtractor()

    fh = codecs.open(gl.training_data_result_file_name, 'w', encoding='utf-8')
